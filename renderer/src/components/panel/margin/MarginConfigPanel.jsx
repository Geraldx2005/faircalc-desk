      ...
      <div className="flex flex-col gap-2.5">
        <div className="w-full flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-1 text-xs bg-nero-700 border border-nero-600 rounded-md hover:bg-nero-800 transition-all duration-200 ease-in-out focus:outline-none focus:ring-1 focus:border-nero-400"
          >
            Reset Margin
          </button>
