            ...
            <div className="w-full h-8 flex rounded-md">
                ...
                <div className="h-8 w-6 bg-nero-750 border border-nero-600 border-r-0 flex flex-col rounded-bl-md rounded-tl-md overflow-hidden">
                    <button
                        type="button"
                        onClick={increase}
                        className="flex-1 flex items-center justify-center text-nero-400 hover:text-nero-300 focus:outline-none focus:ring-0 focus:border-nero-400"
                    >
                ...
                <input
                    ...
                    className="no-spinner w-[80%] h-8 px-2 py-1 bg-nero-700 
                    border border-nero-600 rounded-md rounded-bl-none rounded-tl-none text-sm
                    focus:outline-none focus:ring-1 focus:border-nero-400"
                />
            </div>
        </div>
    );
